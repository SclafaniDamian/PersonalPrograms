...
public class TBWGenerator {
    ...
    private void createArray() {
        ...
        characters.add("513. Lab Assistant");
        characters.add("514. Gloop");
        characters.add("515. Goopy Bones");
        characters.add("516. Blockhead");
        characters.add("517. Goop Giant");
        characters.add("518. Forgotten Legend");
        characters.add("519. Doctor Gladius");
        characters.add("520. Droop");
        characters.add("521. Baby Fin");
        characters.add("522. Blub, Water Mage");
        characters.add("523. Mechano-Maker");
        characters.add("524. Cyborg");
        characters.add("525. Better Bot");
        characters.add("526. Execution Bot");
        characters.add("527. Electrator, Electric Mage");
        characters.add("528. Arcandus, Arcane Mage");
        characters.add("529. Incendious, Fire Mage");
        characters.add("530. Doofus, Earth Mage");
        characters.add("531. Elder Wolf");
        characters.add("532. Janari, Life Mage");
        characters.add("533. Zane, Blood Mage");
        characters.add("534. Underground Bomber");
        characters.add("535. Underground Gardener");
        characters.add("536. Underground Spy");
        characters.add("537. Underground Assassin");
        characters.add("538. Sunflower");
        characters.add("539. Marksman");
        characters.add("540. Underground Gunslinger");
        characters.add("541. Gunslinger");
        characters.add("542. Underground Boxer");
        characters.add("543. Glooped Werewolf");
        characters.add("544. Sorceress");
        characters.add("545. Sorcerer");
        characters.add("546. Scientist");
        characters.add("547. Yakana, Wind Mage");
        characters.add("548. Luminous, Sun Mage");
        characters.add("549. Syd, Moon Mage");
        characters.add("550. Alarm Bot");
        characters.add("551. Screamer");
        characters.add("552. Goopifyer");
        characters.add("553. Snowflake, Ice Mage");
        characters.add("554. Tin Can");
        characters.add("555. Rat Tamer");
        characters.add("556. Potion Chucker");
        characters.add("557. Brewmaster");
        characters.add("558. Underground Brewer");
        characters.add("559. King of the Hill");
        characters.add("560. Lawnmower");
        characters.add("561. Bush");
        characters.add("562. Dandy Lion");
        characters.add("563. Invisi-Bot");
        characters.add("564. Defender");
        characters.add("565. Slop, Goop Mage");
        characters.add("566. Time Stopper");
        characters.add("567. Futuristic Boxer");
        characters.add("568. Spearmint");
        characters.add("569. Radiation");
        characters.add("570. Crab");
        characters.add("571. King Crab");
        characters.add("572. Robo-Crab");
        characters.add("573. The Creator");
        characters.add("574. Marco");
        characters.add("575. Polo");
        characters.add("576. Plup");
        characters.add("577. Goop Knight");
        characters.add("578. Karate Crab");
        characters.add("579. Flare");
        characters.add("580. Rando, Mixed Mage");
        characters.add("581. Rally");
        characters.add("582. Hybrid");
        characters.add("583. Generator Bot");
        characters.add("584. Indian Bowman");
        characters.add("585. Underground Doctor");
        characters.add("586. Underground Swordsman");
        characters.add("587. Agent Goofender");
        characters.add("588. Rocket Bot");
        characters.add("589. Cowboy");
        characters.add("590. Kamikaze");
        characters.add("591. Shieldmaiden");
        characters.add("592. Fives");
        characters.add("593. Anglerfish");
        characters.add("594. Underground Archer");
        characters.add("595. Half");
        characters.add("596. Configurator");
        characters.add("597. Neon");
        characters.add("598. Firestomper");
        characters.add("599. Shieldsmith");
        characters.add("600. Lionheart");
        characters.add("601. Blind Behemoth");
        characters.add("602. Eyeless");
        characters.add("603. Detective");
        characters.add("604. Necromaniac");
        characters.add("605. Minimizer");
        characters.add("606. Pretender");
        characters.add("607. Zombie Brewer");
        characters.add("608. Regeneration Zombie");
        characters.add("609. Secretspeaker");
        characters.add("610. Gunzo");
        characters.add("611. Zero");
        characters.add("612. Seis");
        characters.add("613. Dos");
        characters.add("614. Faker");
        characters.add("615. Imposter");
        characters.add("616. Punk");
        characters.add("617. Alternate");
        characters.add("618. Zombie Punk");
        characters.add("619. Zombie Backup Dancer");
        characters.add("620. Rat Catcher");
        characters.add("621. Sappy Tree");
        characters.add("622. Leaky Tree");
        characters.add("623. Competitor");
        characters.add("624. Bulk");
        characters.add("625. Storm Giant");
        characters.add("626. Crochet");
        characters.add("627. Giant Slayer");
        characters.add("628. Diffuser");
        characters.add("FF1. Lionheart Knight");
        characters.add("FF2. Enslaved Giant");
        characters.add("FF3. Lionheart Archer");
        characters.add("FF4. Lionheart Messenger");
        characters.add("FF5. Lionheart Treeplanter");
        characters.add("FF6. Lionheart Shieldman");
        characters.add("FF7. Underground Infiltrator");
        characters.add("FF8. Arena Caretaker");
        characters.add("FF9. Underground Venomizer");
        characters.add("FF10. Lionheart Catapult");
        characters.add("FF11. Storm");
        characters.add("FF12. Slash");
        characters.add("FF13. Ganym");
        characters.add("FF14. Derek Daggerhand");
        characters.add("FF15. Mysto");
        characters.add("FF16. Twigius");
        characters.add("FF17. Grudge, Your Worst Nightmare");
        characters.add("FF18. Grudge Worshipper");
        characters.add("FF19. Fake Worshipper");
        characters.add("FF20. Crazed Worshipper");
        characters.add("FF21. Lune");
        characters.add("FF22. Sylo");
        characters.add("FF23. Lionheart Treespeaker");
        characters.add("FF24. Spitter");
        characters.add("FF25. Abomination");
        characters.add("FF26. Dracula");
        characters.add("FF27. Cy-Cro");
        characters.add("FF28. Blood Harvester");
        characters.add("FF29. Van Vampslayer");
        characters.add("FF30. Mutant Flytrap");
        characters.add("FF31. Shock Box");
        characters.add("FF32. Rat Hoarder");
        characters.add("FF33. Grave Digger");
        characters.add("FF34. Uno");
        characters.add("FF35. Bonehead");
        characters.add("FF36. Gadgeteer");
        characters.add("FF37. Big League Mascot");
        characters.add("FF38. Big League Cheerleader");
        characters.add("FF39. Skeleton King");
        characters.add("FF40. Skeledancer");
        characters.add("FF41. Mecha-Hawk");
        characters.add("FF42. Snowball");
        characters.add("FF43. Rattlesnake");
        characters.add("FF44. Infectious Zombie");
        characters.add("FF45. Zombuilder");
        characters.add("FF46. Zombie King");
        characters.add("FF47. Mutant Fish");
        characters.add("FF48. Gurgle");
        characters.add("FF49. Indian Bowman");
        characters.add("FF50. Tree of Creation");
        characters.add("FF51. Splitting Tree");
        characters.add("FF52. Lionheart Jester");
        characters.add("FF53. Mutant Frog");
        characters.add("FF54. Track Coach");
        characters.add("FF55. Cross Country Coach");
        characters.add("FF56. Big League Medic");
        characters.add("FF57. Combat Medic");
        characters.add("FF58. Military General");
        characters.add("FF59. Crumble");
        characters.add("FF60. Shatter");
        characters.add("FF61. Lionheart Dwarf");
        characters.add("FF62. Boulderface");
        characters.add("FF63. Firefighter");
        characters.add("FF64. Police Officer");
        characters.add("FF65. Swat");
        characters.add("FF66. Sheriff");
        characters.add("FF67. Lionheart Guard");
        characters.add("FF68. Lionheart Rallymaster");
        characters.add("FF69. Big League Announcer");
        characters.add("FF70. Lionheart");
        characters.add("FF71. Xyle");
        characters.add("FF72. Fusion");
        characters.add("FF73. Crypt");
        characters.add("FF74. Rat Cage");
        characters.add("FF75. Rat King");
        characters.add("FF76. Syd");
        characters.add("FF77. Mimic");
        characters.add("FF78. Dweller");
        characters.add("FF79. Underground Boxer");
        characters.add("FF80. Underground Police");
        characters.add("FF81. Underground Bomber");
        characters.add("FF82. Underground Farmer");
        characters.add("FF83. Varsity");
        characters.add("FF84. Rookie Wrestler");
        characters.add("FF85. Vulcan");
        characters.add("FF86. Unga");
        characters.add("FF87. Vlinn");
        characters.add("FF88. Crystal");
        characters.add("FF89. Sylus");
        characters.add("FF90. Dr. Gladius");
        characters.add("FF91. Mothership");
        characters.add("FF92. Dr. Doofderbruger");
        characters.add("FF93. Bot Commander");
        characters.add("FF94. Bot Sergeant");
        characters.add("FF95. Boxbot");
        characters.add("FF96. Mecha-Box");
        characters.add("FF97. Lena");
        characters.add("FF98. Yundi");
        characters.add("FF99. Dard");
        characters.add("FF100. Honey");
        characters.add("FF101. Calvin");
        characters.add("FF102. Cosmo");
        characters.add("FF103. Crondus");
        characters.add("FF104. Indian Tribecaller");
        characters.add("FF105. Indian Horseman");
        characters.add("FF106. Dark Horseman");
        characters.add("FF107. Indian Tamer");
        characters.add("FF108. Lionheart Horseback");
        characters.add("FF109. Warcry");
        characters.add("FF110. Bulk");
        characters.add("FF111. Dr. Gloopenburg");
        characters.add("FF112. Cienna");
        characters.add("FF113. Agrippa");
        characters.add("FF114. Underground Coder");
        characters.add("FF115. Night Storm");
        characters.add("FF116. Beetle Dragon");
        characters.add("FF117. Ender-OH");
        characters.add("FF118. Tank Commander");
        characters.add("FF119. Boombot");
        characters.add("FF120. Blueberry Bush");
        characters.add("FF121. Icelandic Lumberjack");
        characters.add("FF122. Rulebender");
        characters.add("FF123. Icelandic Hunter");
        characters.add("FF124. Frostfoot");
        characters.add("FF125. Human Shield");
        characters.add("FF126. Gunzo");
        characters.add("FF127. Clone-O-Bot");
        characters.add("FF128. Cloning Machine");
        characters.add("FF129. Mimic_Bot");
        characters.add("FF130. Spitfire");
        characters.add("FF131. Hooded Archer");
        characters.add("FF132. Centaurius");
        characters.add("FF133. Grudge's Apprentice");
        characters.add("FF134. Military Soldier");
        characters.add("FF135. Military Sniper");
        characters.add("FF136. Sniper Tower");
        characters.add("FF137. Knife Juggler");
        characters.add("FF138. Watchtower");
        characters.add("FF139. Nightmare");
        characters.add("FF140. Jungle Panther");
        characters.add("FF141. Brown Bear");
        characters.add("FF142. Infected Horseman");
        characters.add("FF143. Zomb-O-Tron");
        characters.add("FF144. Crawler");
        characters.add("FF145. Zombot");
        characters.add("FF146. Snakeagleperson");
        characters.add("FF147. Casino Host");
        characters.add("FF148. Underground Cheater");
        characters.add("FF149. Cannonball");
        characters.add("FF150. Mana Seed");
        characters.add("FF151. Mana Knight");
        characters.add("FF152. Necro Knight");
        characters.add("FF153. Darkwood Necromancer");
        characters.add("FF154. Darkwood Tree");
        characters.add("FF155. Protector Peach");
        characters.add("FF156. Underground Saboteur");
        characters.add("FF157. Mana Alter");
        characters.add("FF158. Siete");
        characters.add("FF159. Splinteroot");
        characters.add("FF160. Groof");
        characters.add("FF161. Cursed Tree");
        characters.add("FF162. Military Tank");
        characters.add("FF163. Underground Exterminator");
        characters.add("FF164. Indian Brute");
        characters.add("FF165. Lafra");
        characters.add("FF166. Whiplash");
        characters.add("FF167. Indian Shaman");
        characters.add("FF168. Seis");
        characters.add("FF169. Radioactive Zombie");
        characters.add("FF170. Crochet Player");
        characters.add("FF171. Underground Stabber");
        characters.add("FF172. Grave Raiser");
        characters.add("FF173. Paradoxal Gatekeeper");
        characters.add("FF174. Free Spirit");
        characters.add("FF175. Flame Spirit");
        characters.add("FF176. Frost Spirit");
        characters.add("FF177. Wildlife Spirit");
        characters.add("FF178. Life Spirit");
        characters.add("FF179. Earth Spirit");
        characters.add("FF180. Sand Spirit");
        characters.add("FF181. Sand Golem");
        characters.add("FF182. Stone Spirit");
        characters.add("FF183. Water Golem");
        characters.add("FF184. Aqua Spirit");
        characters.add("FF185. Indian Berserker");
        characters.add("FF186. Lionheart Shieldmaiden");
        characters.add("FF187. Underground Scavenger");
        characters.add("FF188. Arena Fanatic");
        characters.add("FF189. Junkbot");
        characters.add("FF190. Arena Beastkeeper");
        characters.add("FF191. Skeletal Resurrectionist");
        characters.add("FF192. Skeletal Mage");
        characters.add("FF193. Arena Announcer");
        characters.add("FF194. Crowd Favorite");
        characters.add("FF195. Arena Rival");
        characters.add("FF196. Arena Medic");
        characters.add("FF197. Void");
        characters.add("FF198. The Voice");
        characters.add("FF199. Arena Enforcer");
        characters.add("FF200. Spite");
        characters.add("FF201. Hrungnir");
        characters.add("FF202. Glory");
        characters.add("FF203. Magi");
        characters.add("FF204. Tingtuk");
        characters.add("FF205. King Stontaun");
        characters.add("FF206. Meghoul");
        characters.add("FF207. Chess King");
        characters.add("FF208. Chess Player");
        characters.add("FF209. Manuzing");
        characters.add("FF210. Immortal");
        characters.add("FF211. Kanicon");
        characters.add("FF212. Mana Spirit");
        characters.add("FF213. Necro Spirit");
        characters.add("FF214. Token Spirit");
